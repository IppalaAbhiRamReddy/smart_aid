...
class LocalizationService extends ChangeNotifier {
  ...
  final Map<String, Map<String, String>> _translations = {
    'en': {
      ...
      // Reminders
      'reminders_title': 'Medication',
      'morning': 'Morning',
      'afternoon': 'Afternoon',
      'evening': 'Evening',
      'add_reminder': 'Add Note',
      'edit_reminder': 'Edit Note',
      'label': 'Label',
      'repeat': 'Repeat',
      'every_day': 'Every Day',
    ...
    'te': {
      ...
      // Reminders
      'reminders_title': 'మందుల గమనికలు',
      'morning': 'ఉదయం',
      'afternoon': 'మధ్యాహ్నం',
      'evening': 'సాయంత్రం',
      'add_reminder': 'గమనికను జోడించండి',
      'edit_reminder': 'గమనికను సవరించండి',
      'label': 'పేరు',
      'repeat': 'పునరావృతం',
      ...
      'cancel': 'రద్దు',
      'delete': 'తొలగించండి',
      'delete_confirm': 'ఈ గమనికను తొలగించాలా?',
      'no_reminders': 'ఇంకా గమనికలు లేవు',
